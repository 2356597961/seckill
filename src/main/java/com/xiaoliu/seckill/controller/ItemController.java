...
import com.xiaoliu.seckill.service.CacheService;
...
import com.xiaoliu.seckill.viewobject.ItemVO;
...
public class ItemController extends BaseController {
    ...
    public CommonReturnType getItem(@RequestParam(name = "id")Integer id){
        ItemModel itemModel = getItemModel(id);
    ...
    public ItemModel getItemModel(Integer id) {
