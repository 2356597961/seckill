    ...
    <header>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="${sku.imgUrl}" width="100%"></img></div>
            </div>
            <!-- 如果需要分页器 -->
        ...
        <div class="detailsInfo">
            ...
            <div style="flex: 1; padding-top: 20px;padding-left: 10px;">
                <div><span>￥</span><span style="font-size: 20px;font-weight: bold">${deprecate}</span></div>
            ...
            <div style="padding-top: 15px;padding-right: 15px;">
                ...
                <div id="time" class="time"><span>{{hours}}</span> ：<span>{{minutes}}</span> ：<span>{{seconds}}</span>
                </div>
            </div>
        </div>
    </header>
...
<script>
    var app = new Vue({
        ...
        methods: {
            ...
            loadTime: function () {
                //秒杀倒计时时间
                let tm1 = new Date("${startDate?string('yyyy-MM-dd HH:mm:ss')}").getTime();
                let tm2 = new Date("${endDate?string('yyyy-MM-dd HH:mm:ss')}").getTime();
            ...
            addOrder: function () {
                ...
                if (token != null && token != '') {
                    ...
                    //发送请求
                    instance.post(`http://localhost:8088/order/createorder/add?id=${sku.id}`).then(function (response) {
